...
**Centre logistic:**  
Atributs: Id , Ubicació  
Dsitribueix Lot  
Negocia PeticioTransport  
RepOferta RespostaOfertaTransport  
RepAvís ProducteLocalitzat

ProducteLocalitzat  
Atributs: adreça, dataenviament (la de detsi del producte, osigui la de la comanda), caldria posar tambe la data d’enviament?de moment la he posat  
EsFaSobr Producte  
(s’avisa) RepAvís CentreLogistic  
   
**PeticióTransport**  
Atributs: DataEnviament, Pes  
Demana OfertaTransport  
(és negociat) Negocia CentreLogistic  
(és rebuda per) RepUna Transportista

**Transportista**  
Atributs; Cost base, id, ubicacio  
Genera RespostaOfertaTransport  
RepUna PeticióTransport  
ÉsEscollit EleccióTransportista

**RespostaOfertaTransport**  
(és generadA) Genera Transportista  
Proposa OfertaTransport  
(ésrebudaper) RepOferta CentreLogistic

**EleccioTransportista**  
(escull) ÉsEscollit Transportista
